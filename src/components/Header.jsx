    ...
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-xl border-b border-slate-200 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 h-16 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2 group">
          ...
          <span className="text-lg md:text-xl font-bold bg-gradient-to-r from-[#8a61ee] to-[#6b46cc] bg-clip-text text-transparent">
            ApplyCraft
          </span>
        </Link>
          ...
          {user && (
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="hidden md:flex items-center gap-2 px-3 py-2 rounded-xl hover:bg-slate-100 transition-colors"
              >
                ...
                <span className="hidden sm:flex text-sm text-slate-600 max-w-[150px] truncate">
